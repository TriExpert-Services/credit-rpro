  ...
  return (
    <div className="min-h-screen bg-slate-950 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-slate-800/50 backdrop-blur-sm rounded-2xl shadow-xl p-8 md:p-12 space-y-8 border-2 border-rose-500/20">
          ...
          <section className="border-b border-slate-700/50 pb-8">
            ...
            <div className="bg-sky-500/10 rounded-xl p-6 border border-sky-500/30 mb-6">
            ...
            <ul className="space-y-4">
              <li className="flex items-start gap-4 p-4 bg-slate-700/30 rounded-xl">
                <CheckCircle className="w-6 h-6 text-emerald-400 flex-shrink-0 mt-0.5" />
                <div>
                  <p className="font-semibold text-white">Derecho a Cancelar</p>
              ...
              <li className="flex items-start gap-4 p-4 bg-slate-700/30 rounded-xl">
                <CheckCircle className="w-6 h-6 text-emerald-400 flex-shrink-0 mt-0.5" />
                <div>
                  <p className="font-semibold text-white">Disputas Gratuitas Directas</p>
                  <p className="text-slate-300">
              ...
              <li className="flex items-start gap-4 p-4 bg-slate-700/30 rounded-xl">
                <CheckCircle className="w-6 h-6 text-emerald-400 flex-shrink-0 mt-0.5" />
                <div>
                  <p className="font-semibold text-white">Derecho a Demandar</p>
                  <p className="text-slate-300">
              ...
              <li className="flex items-start gap-4 p-4 bg-slate-700/30 rounded-xl">
                <CheckCircle className="w-6 h-6 text-emerald-400 flex-shrink-0 mt-0.5" />
                <div>
                  <p className="font-semibold text-white">Reporte de Crédito Gratuito</p>
                  <p className="text-slate-300">
                    ...
                    target="_blank" rel="noopener noreferrer" className="text-sky-400 underline">
          ...
          <section className="border-b border-slate-700/50 pb-8">
            ...
            <div className="grid md:grid-cols-3 gap-4">
              <div className="bg-slate-700/30 rounded-xl p-5 border border-slate-700/50">
                <h4 className="font-bold text-white mb-3">EQUIFAX</h4>
                <p className="text-sm text-slate-300 mb-1">P.O. Box 740241</p>
                <p className="text-sm text-slate-300 mb-1">Atlanta, GA 30374</p>
                <p className="text-sm text-slate-300 mb-1">1-800-685-1111</p>
                <p className="text-sm text-sky-400">www.equifax.com</p>
              </div>
              
              <div className="bg-slate-700/30 rounded-xl p-5 border border-slate-700/50">
                <h4 className="font-bold text-white mb-3">EXPERIAN</h4>
                <p className="text-sm text-slate-300 mb-1">P.O. Box 4500</p>
                <p className="text-sm text-slate-300 mb-1">Allen, TX 75013</p>
                <p className="text-sm text-slate-300 mb-1">1-888-397-3742</p>
                <p className="text-sm text-sky-400">www.experian.com</p>
              </div>
              
              <div className="bg-slate-700/30 rounded-xl p-5 border border-slate-700/50">
                <h4 className="font-bold text-white mb-3">TRANSUNION</h4>
                <p className="text-sm text-slate-300 mb-1">P.O. Box 1000</p>
                <p className="text-sm text-slate-300 mb-1">Chester, PA 19016</p>
                <p className="text-sm text-slate-300 mb-1">1-800-916-8800</p>
                <p className="text-sm text-sky-400">www.transunion.com</p>
              </div>
            </div>
          </section>
              ...
              <div className="space-y-2 text-amber-400">
                ...
                <p>
                  ...
                  <a href="https://www.ftc.gov" target="_blank" rel="noopener noreferrer" 
                     className="text-sky-400 underline">www.ftc.gov</a>
                </p>
                <p>
                  <strong>Reportar quejas:</strong>{' '}
                  <a href="https://reportfraud.ftc.gov" target="_blank" rel="noopener noreferrer"
                     className="text-sky-400 underline">reportfraud.ftc.gov</a>
                </p>
              </div>
            </div>
          </section>
          ...
          <section className="border-b border-slate-700/50 pb-8">
            ...
            <div className="bg-emerald-500/10 rounded-xl p-6 border border-emerald-500/30">
              ...
              <ul className="list-disc list-inside text-emerald-400 space-y-2 mb-4">
          ...
          {/* Acknowledgment */}
          <section className="mt-8 pt-8 border-t-2 border-slate-600/50">
            <div className="bg-amber-500/10 rounded-xl p-6 border-2 border-amber-500/40">
        ...
        <div className="text-center mt-8 space-y-4">
          <button 
            ...
            className="inline-flex items-center gap-2 px-6 py-3 bg-slate-800 text-white rounded-xl font-semibold hover:bg-slate-900 transition-colors"
          >
            <FileText className="w-5 h-5" />
