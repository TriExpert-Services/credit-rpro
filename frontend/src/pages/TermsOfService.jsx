      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-slate-800/50 backdrop-blur-sm rounded-2xl shadow-xl p-8 md:p-12 space-y-8">
          ...
          <section>
            ...
            <p className="text-slate-300 mb-4">TriExpert Credit Repair proporciona:</p>
            <div className="grid md:grid-cols-2 gap-4">
              <div className="bg-slate-700/30 rounded-xl p-4">
                <h4 className="font-semibold text-white mb-2">Análisis de Crédito</h4>
                <p className="text-slate-300 text-sm">Revisión detallada de sus reportes de crédito de las tres burós principales usando IA avanzada.</p>
              </div>
              <div className="bg-slate-700/30 rounded-xl p-4">
                <h4 className="font-semibold text-white mb-2">Generación de Disputas</h4>
                <p className="text-slate-300 text-sm">Creación automática de cartas de disputa personalizadas para elementos negativos.</p>
              </div>
              <div className="bg-slate-700/30 rounded-xl p-4">
                <h4 className="font-semibold text-white mb-2">Seguimiento de Progreso</h4>
                <p className="text-slate-300 text-sm">Monitoreo continuo de sus disputas y mejoras en su puntaje crediticio.</p>
              </div>
              <div className="bg-slate-700/30 rounded-xl p-4">
                <h4 className="font-semibold text-white mb-2">Verificación de Identidad</h4>
                <p className="text-slate-300 text-sm">Integración con Plaid para verificación bancaria segura.</p>
              </div>
            </div>
          </section>
          ...
          <section>
            ...
            <p className="text-slate-300 mb-4">Al usar nuestros servicios, usted se compromete a:</p>
            <ul className="space-y-3">
              <li className="flex items-start gap-3">
                <CheckCircle className="w-5 h-5 text-green-500 mt-0.5 flex-shrink-0" />
                <span className="text-slate-300">Proporcionar información veraz, precisa y completa</span>
              </li>
              <li className="flex items-start gap-3">
                <CheckCircle className="w-5 h-5 text-green-500 mt-0.5 flex-shrink-0" />
                <span className="text-slate-300">Mantener la confidencialidad de sus credenciales de acceso</span>
              </li>
              <li className="flex items-start gap-3">
                <CheckCircle className="w-5 h-5 text-green-500 mt-0.5 flex-shrink-0" />
                <span className="text-slate-300">Notificarnos inmediatamente de cualquier uso no autorizado</span>
              </li>
              <li className="flex items-start gap-3">
                <CheckCircle className="w-5 h-5 text-green-500 mt-0.5 flex-shrink-0" />
                <span className="text-slate-300">No utilizar el servicio para actividades ilegales o fraudulentas</span>
              </li>
              <li className="flex items-start gap-3">
                <CheckCircle className="w-5 h-5 text-green-500 mt-0.5 flex-shrink-0" />
                <span className="text-slate-300">Ser mayor de 18 años o tener consentimiento parental</span>
              </li>
            </ul>
          </section>
          ...
          <section>
            ...
            <div className="space-y-4">
              <div className="bg-sky-500/10 rounded-xl p-6 border border-sky-500/20">
                <h4 className="font-semibold text-sky-400 mb-2">Suscripciones</h4>
                <ul className="list-disc list-inside text-sky-400 space-y-1 text-sm">
              ...
              <div className="bg-amber-500/10 rounded-xl p-6 border border-amber-500/20">
                <h4 className="font-semibold text-amber-400 mb-2">Cancelación</h4>
                <ul className="list-disc list-inside text-amber-400 space-y-1 text-sm">
            ...
            <div className="bg-rose-500/10 rounded-xl p-6 border border-rose-500/20">
              ...
              <ul className="space-y-2">
                <li className="flex items-start gap-3">
                  ...
                  <span className="text-rose-400">Un aumento específico en su puntaje de crédito</span>
                </li>
                <li className="flex items-start gap-3">
                  <XCircle className="w-5 h-5 text-red-500 mt-0.5 flex-shrink-0" />
                  <span className="text-rose-400">La eliminación de elementos negativos legítimos</span>
                </li>
                <li className="flex items-start gap-3">
                  <XCircle className="w-5 h-5 text-red-500 mt-0.5 flex-shrink-0" />
                  <span className="text-rose-400">Un plazo específico para ver resultados</span>
                </li>
                <li className="flex items-start gap-3">
                  <XCircle className="w-5 h-5 text-red-500 mt-0.5 flex-shrink-0" />
                  <span className="text-rose-400">Aprobación de préstamos o líneas de crédito</span>
                </li>
              </ul>
          ...
          <section>
            ...
            <div className="bg-indigo-500/15 rounded-xl p-6 border border-indigo-500/30">
              ...
              <ul className="list-disc list-inside text-indigo-400 space-y-1">
          ...
          <section className="border-t border-slate-700/50 pt-8">
            ...
            <div className="bg-slate-700/30 rounded-xl p-4">
              <p className="text-slate-300"><strong>Email:</strong> legal@triexpertservice.com</p>
              <p className="text-slate-300"><strong>Teléfono:</strong> (813) 369-3340</p>
              <p className="text-slate-300"><strong>Dirección:</strong> 2800 E 113th Ave, Tampa, FL 33617</p>
            </div>
          </section>
        </div>
