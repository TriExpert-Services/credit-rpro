        ...
        <div className="bg-white rounded-2xl shadow-xl p-8 md:p-12 space-y-8">
          ...
          <section>
            ...
            <div className="grid md:grid-cols-2 gap-4">
              <div className="bg-green-50 rounded-xl p-4 border border-green-100">
                <h4 className="font-semibold text-green-800 mb-2">🔐 Encriptación</h4>
                <p className="text-green-700 text-sm">Todos los datos se transmiten usando SSL/TLS y se almacenan encriptados</p>
              </div>
              <div className="bg-blue-50 rounded-xl p-4 border border-blue-100">
                <h4 className="font-semibold text-blue-800 mb-2">🛡️ Autenticación</h4>
                <p className="text-blue-700 text-sm">Autenticación segura con Auth0 y verificación de dos factores</p>
              </div>
              <div className="bg-purple-50 rounded-xl p-4 border border-purple-100">
                <h4 className="font-semibold text-purple-800 mb-2">🏦 PCI Compliance</h4>
                <p className="text-purple-700 text-sm">Procesamiento de pagos compatible con PCI DSS a través de Stripe</p>
              </div>
              <div className="bg-amber-50 rounded-xl p-4 border border-amber-100">
                <h4 className="font-semibold text-amber-800 mb-2">📊 Auditorías</h4>
          ...
          <section>
            ...
            <div className="bg-indigo-50 rounded-xl p-6 border border-indigo-100">
              <p className="text-indigo-900"><strong>Email:</strong> privacy@triexpertservice.com</p>
              <p className="text-indigo-900"><strong>Teléfono:</strong> (813) 369-3340</p>
              <p className="text-indigo-900"><strong>Dirección:</strong> 2800 E 113th Ave, Tampa, FL 33617</p>
            </div>
          </section>
