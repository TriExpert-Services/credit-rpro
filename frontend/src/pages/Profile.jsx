  ...
  return (
    <div className="max-w-4xl mx-auto space-y-6 pb-8">
      ...
      <div className="bg-gradient-to-br from-slate-900 via-indigo-900 to-purple-900 rounded-2xl p-6 text-white relative overflow-hidden">
        <div className="absolute top-0 right-0 w-64 h-64 bg-slate-800/50/5 rounded-full -translate-y-32 translate-x-32"></div>
        <div className="absolute bottom-0 left-0 w-48 h-48 bg-slate-800/50/5 rounded-full translate-y-24 -translate-x-24"></div>
        ...
        <div className="relative z-10 flex items-center gap-6">
          <div className="relative">
            ...
            <button className="absolute -bottom-2 -right-2 p-2 bg-slate-800/50 backdrop-blur-sm rounded-xl text-slate-300 shadow-lg hover:bg-slate-700/30 transition-colors">
              <Camera size={16} />
            </button>
          </div>
          <div>
            ...
            <div className="flex items-center gap-2 mt-2">
              <span className="px-3 py-1 bg-slate-800/50/20 rounded-full text-sm capitalize">{user?.role || 'Client'}</span>
        ...
        <form onSubmit={handleSubmit} className="p-6">
            ...
            <div className="space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  ...
                  <input 
                    ...
                    className="w-full px-4 py-3 border border-slate-700/50 rounded-xl focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition-all" 
              ...
              <div>
                ...
                <input 
                  ...
                  className="w-full px-4 py-3 border border-slate-700/50 rounded-xl bg-slate-700/30 text-slate-400 cursor-not-allowed" 
                  disabled 
                />
          ...
          {activeTab === 'address' && (
            <div className="space-y-6">
              ...
              <div>
                <label className="text-sm font-medium text-slate-300 mb-2 block">Apt/Suite (Optional)</label>
                <input 
                  type="text" 
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div>
                  <label className="text-sm font-medium text-slate-300 mb-2 block">ZIP Code</label>
                  <input 
                    type="text" 
            ...
            <div className="space-y-6">
              <div className="p-4 bg-amber-500/10 border border-amber-500/30 rounded-xl">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="font-medium text-amber-400">Password</p>
                    <p className="text-sm text-amber-400">Last changed 30 days ago</p>
                  </div>
                  <button 
                    type="button"
                    onClick={() => {
                    ...
                    className="ml-auto px-4 py-2 bg-amber-500/20 text-amber-400 rounded-lg hover:bg-yellow-200 transition-colors text-sm font-medium"
                  >
                    Change Password
                  </button>
                </div>
              ...
              <div className={`p-4 rounded-xl border ${
                ...
                <div className="flex items-center gap-3">
                  <Shield size={20} className={twoFactorEnabled ? 'text-emerald-400' : 'text-slate-400'} />
                  <div>
                    <p className={`font-medium ${twoFactorEnabled ? 'text-emerald-400' : 'text-slate-200'}`}>
                      Two-Factor Authentication
                    </p>
                    <p className={`text-sm ${twoFactorEnabled ? 'text-emerald-400' : 'text-slate-400'}`}>
                      {twoFactorEnabled 
                  ...
                  <button 
                    ...
                    className={`ml-auto px-4 py-2 rounded-lg transition-colors text-sm font-medium ${
                      twoFactorEnabled 
                        ? 'bg-emerald-500/20 text-emerald-400 hover:bg-green-200' 
              ...
              <div className="p-4 bg-sky-500/10 border border-sky-500/30 rounded-xl">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="font-medium text-sky-400">Notifications</p>
                    <p className="text-sm text-sky-400">Email notifications are enabled</p>
                  </div>
                  <button 
                    type="button"
                    className="ml-auto px-4 py-2 bg-sky-500/20 text-sky-400 rounded-lg hover:bg-blue-200 transition-colors text-sm font-medium"
                  >
                    Configure
                  </button>
                </div>
          ...
          {/* Save Button */}
          {activeTab !== 'security' && (
            <div className="flex justify-end pt-6 mt-6 border-t border-slate-700/30">
              <button 
                type="submit" 
                disabled={saving}
                className="flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-indigo-600 to-purple-600 text-white rounded-xl font-medium hover:from-indigo-700 hover:to-purple-700 transition-all shadow-lg shadow-indigo-500/25 disabled:opacity-50 disabled:cursor-not-allowed"
              >
                {saving ? (
                  <>
      ...
      {showChangePassword && (
        <div className="fixed inset-0 bg-black/60 backdrop-blur-sm z-50 flex items-center justify-center p-4">
          <div className="bg-slate-800 rounded-2xl shadow-2xl w-full max-w-md p-6 relative animate-scale-in">
            <button
              type="button"
            ...
            <div className="text-center mb-6">
              ...
              <p className="text-slate-400 text-sm mt-1">Ingresa tu contraseña actual y la nueva</p>
            </div>
            ...
            <form onSubmit={handleChangePassword} className="space-y-4">
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    className="w-full px-4 py-3 pr-12 border border-slate-700/50 rounded-xl focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition-all"
              ...
              <div className="flex gap-3 pt-2">
                <button
                  type="button"
                  onClick={() => setShowChangePassword(false)}
                  className="flex-1 py-3 border border-slate-700/50 rounded-xl text-slate-300 font-medium hover:bg-slate-700/30 transition-colors"
                >
                  Cancelar
                </button>
                <button
